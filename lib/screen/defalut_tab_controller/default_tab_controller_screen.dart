...
class _DefaultTabControllerScreenState extends State<DefaultTabControllerScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("DefaultTabController"),),
  ...
  TabBarView _tabBarView() {
    return TabBarView(
        ...
        children: [
          ...
          Container(margin: EdgeInsets.symmetric(horizontal: 10), color: Colors.red),
          Container(margin: EdgeInsets.symmetric(horizontal: 10), color: Colors.blue),
        ]
    );
  }
}
